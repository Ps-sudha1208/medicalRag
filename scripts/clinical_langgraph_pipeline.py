...
def load_faiss_store(faiss_dir: Path):
    embeddings = HuggingFaceEmbeddings(model_name=MINILM_MODEL, model_kwargs={'device': 'cpu'})
...
#     if not path.exists():
#         raise FileNotFoundError(f"FAISS directory not found: {path}")
    
#     # Add explicit cache_folder parameter
#     import os
#     cache_dir = os.path.expanduser("~/.cache/huggingface/hub")
    
#     embeddings = HuggingFaceEmbeddings(
#         model_name=MINILM_MODEL,
#         cache_folder=cache_dir  # Add this line
#     )
